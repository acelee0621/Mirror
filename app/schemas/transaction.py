...
from app.schemas.account import AccountPublic, AccountPublicWithOwner
...
class TransactionPublicWithOwner(BaseSchema):
    """
    通过API返回给前端的、完整的交易公开信息。
    """
    ...
    # --- 【核心确认点】: 使用了包含 owner 信息的 Schema ---
    # 这确保了API对每笔交易的响应都包含了必要的 owner_id
    account: AccountPublicWithOwner
    counterparty: CounterpartyPublic
