...
Revision ID: 103f7f78a83c
Revises: 
Create Date: 2025-06-26 17:36:28.622166
...
def upgrade() -> None:
    ...
    sa.Column('bank_transaction_id', sa.String(), nullable=False, comment='银行系统生成的唯一交易流水号，用于防止重复导入'),
